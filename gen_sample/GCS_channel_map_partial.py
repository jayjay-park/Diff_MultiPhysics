...
def least_squares_posterior_estimation(model, input_data, true_data, num_iterations=500, learning_rate=1e-2):
...
for i in range(num_batch):
    ...
    posterior_estimate_mse = least_squares_posterior_estimation(MSE_model, X, Y_true, num_iterations=100)
    posterior_estimate_jac = least_squares_posterior_estimation(JAC_model, X, Y_true, num_iterations=100)
    ...
    for b in range(batch_size):
        ...
        path = f'GCS_partial/both_{num_col}/posterior_{i}_{b}'
