...
if __name__ == "__main__":
    ...
    # Read the first file
    with h5py.File('../data/GCS/FIM_data_samples_first_step.h5', 'r') as f1, \
        h5py.File('../data/GCS/FIM_data_samples_two_step.h5', 'r') as f2, \
        h5py.File('../data/GCS/FIM_data_samples_third_step.h5', 'r') as f3, \
        h5py.File('../data/GCS/FIM_data_samples_fourth_step.h5', 'r') as f4:
