---
title: "DFINO: Derivative-based Fisher-Informed Neural Operator"
subtitle: "Jayjay Park, Tuna, Jason, Richard"
format:
  revealjs: 
...
title-slide-attributes:
  ...
  data-notes: |
    Hi everyone. You can put speaker notes on the title slide here.

    Particularly, the title of this talk is very good, and next I will show you why I am giving this talk.
# slides:
...
## Hello, I'm a new MS student {.smaller}
- MS student in ECE department.
- Background:
- Surrogate Modeling in Chaotic Systems.
- Include
...
## Problem {.smaller}
What is neural operator learning?
image of mapping: Permeability(image) -> Saturation(image) 

## Objective {.smaller}

## What type of systems are we learning? {.smaller transition="slide"}

::: columns
::: {.column width="40%"}
- To rigorously evaluate the effectiveness of our method, we first train on challenging mathematical models, including a chaotic system:
  1. Lorenz '63
  2. Navier-Stokes Equations
- We also assess the practicality of our model on real-world systems, such as:
  1. A simplified geological carbon storage problem
:::
...
## Result: Lorenz `63 {.smaller}

## Result: Naiver Stokes {.smaller}

## Result: Twophase Flow (Multi-step prediction) {.smaller}

## Result: Twophase Flow (Single-step prediction) {.smaller}

## Key Takeaway {.smaller}

1. Derivative info can substantially improve the function approximation.
